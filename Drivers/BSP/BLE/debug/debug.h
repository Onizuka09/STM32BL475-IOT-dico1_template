 ...
 */
#ifdef UART_ENABLED 
#define print_uart(...) printf(__VA_ARGS__)
#define no_print_uart()
#else 
...
#define DBG_PRINT(...) print_uart(__VA_ARGS__)
#define PRINT_MESG_DBG(...)
#define DBG_ASSERT(expression)
#define PRINT_MESG_DBG(...) print_uart(__VA_ARGS__)
#define PRINT_MESG_DATA(file,dptr,dlen) 
#define PRINT_MESG_INFO(...) print_uart(__VA_ARGS__)
#define PRINT_MESG_ERR(...) print_uart(__VA_ARGS__)
